...
import { sectionData } from './accordionReducer'
...
function Form() {
    ...
    return (
        <>
        <h1 className='bg-transparent p-3 text-center text-white'>Accordion</h1>
           ...
           <div className=' col-3  shadow p-3 mb-5 bg-white rounded mt-5' style={{ margin: "0 " }}>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='d-flex justify-content-start'>
                        <button className='btn px-4 btn-primary btn-block' type='submit'>Add</button>
                    </div>
                </form>
            </div>
